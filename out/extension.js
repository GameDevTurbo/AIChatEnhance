...
const PlannerPanel_1 = require("./PlannerPanel");
function activate(context) {
    // Sidebar welcome view — shows a link to open the main panel
    context.subscriptions.push(vscode.window.registerTreeDataProvider('taskPlannerView', {
        getTreeItem: (el) => new vscode.TreeItem(el),
        getChildren: () => [],
    }));
